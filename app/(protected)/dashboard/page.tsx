...
export default async function DashboardPage() {
  ...
  // Example: Fetch data from NestJS
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600">Welcome back, manage your account and settings</p>
      </div>

      <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-gray-100">
        <div className="flex items-center space-x-4 mb-4">
          <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center">
            <span className="text-white text-2xl font-bold">{session?.user.name?.charAt(0).toUpperCase()}</span>
          </div>
          <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow p-6 border border-gray-100">
          ...
          <ul className="space-y-3">
            <li>
              <Link href="/profile" className="flex items-center text-blue-600 hover:text-purple-600 font-medium transition-colors">
